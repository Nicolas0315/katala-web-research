...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_search.add_argument("--provider", default="ddg", choices=["brave", "ddg", "github", "jina", "searxng"])
    ...
    p_collect.add_argument("--provider", default="ddg", choices=["brave", "ddg", "github", "jina", "searxng"])
    ...
    p_brief.add_argument("--provider", default="ddg", choices=["brave", "ddg", "github", "jina", "searxng"])
    ...
    p_investigate.add_argument("--provider", default="ddg", choices=["brave", "ddg", "github", "jina", "searxng"])
...
def cmd_brief(args: argparse.Namespace) -> int:
    web_results = [] if args.no_web else search(args.query, provider=args.provider, limit=args.web_limit)
    archive = Archive(args.archive)
    try:
